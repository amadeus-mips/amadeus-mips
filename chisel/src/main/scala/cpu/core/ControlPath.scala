package cpu.core
  ...
  class CtlToDatIo extends Bundle()
  {
    ...
    //  whether the pipeline is executing a fence
    val fencei     = Output(Bool())    // pipeline is executing a fencei

    //  is the memory illegal
    //  TODO: what is exactly fencei
    //  well, turns out this is a fence instruction. Don't really know why it is here
