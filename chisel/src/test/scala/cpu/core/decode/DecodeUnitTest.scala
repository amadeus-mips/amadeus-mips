...
//    poke(de.io.rtData, opData2)
//
//    expect(de.io.out.exeOp, aluOp)
//    //    expect(de.io.out.inst, inst.U(32.W))
//    if(writeEnable) expect(de.io.out.write.address, rd)
//    expect(de.io.out.write.enable, writeEnable)
//    expect(de.io.out.op1, opData1)
//    expect(de.io.out.op2, opData2)
...
//
//    expect(de.io.out.exeOp, aluOp)
//    expect(de.io.out.write.address, rt)
//    expect(de.io.out.write.enable, writeEnable)
//    expect(de.io.out.op1, opData1)
//    expect(de.io.out.op2, immExt)
//    //    println(s"$name test finished")
//    step(1)
//  })
//
...
//    poke(de.io.rsData, opData1)
//    poke(de.io.rtData, opData2)
//    expect(de.io.out.write.enable, false)
...
//    poke(de.io.rsData, opData1)
//    poke(de.io.rtData, opData2)
//    if(writeEnable) expect(de.io.out.write.address, cpu.core.Constants.GPR31)
//    expect(de.io.out.write.enable, writeEnable)
//    expect(de.io.branchFlag, branchFlag)
//    expect(de.io.branchTarget, branchTarget)
//    step(1)
