    ...
    val controlSignals =
      ListLookup(io.input.instr,
        ...
        Array(           //branch,  jump,   dst     reg, wb enabl    func, _mem   MEM_   MASK_WORD,      BRANCH_CMP_EQ,               JUMP_REG,       MEM_SEXT_N,      write enable,
          ...
          ADDU    ->  List(BRANCH_N,    JUMP_N,       DST_RD,   WB_Y,    OPB_RT,          ALU_ADD,        BRANCH_X,                    JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          ADDI    ->  List(BRANCH_N,    JUMP_N,       DST_RT,   WB_Y,    OPB_OFFSET,      ALU_ADD,        BRANCH_X,                    JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          ADDIU   ->  List(BRANCH_N,    JUMP_N,       DST_RT,   WB_Y,    OPB_OFFSET,      ALU_ADD,        BRANCH_X,                    JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          SUB     ->  List(BRANCH_N,    JUMP_N,       DST_RD,   WB_Y,    OPB_RT,          ALU_SUB,        BRANCH_X,                    JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          SUBU    ->  List(BRANCH_N,    JUMP_N,       DST_RD,   WB_Y,    OPB_RT,          ALU_SUB,        BRANCH_X,                    JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          ...
          BEQ     ->  List(BRANCH_Y,    JUMP_N,       DST_X,    WB_N,    OPB_RT,          ALU_ADD,        BRANCH_CMP_EQ,               JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          BNE     ->  List(BRANCH_Y,    JUMP_N,       DST_X,    WB_N,    OPB_RT,          ALU_ADD,        BRANCH_CMP_N_EQ,             JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          BGEZ    ->  List(BRANCH_Y,    JUMP_N,       DST_X,    WB_N,    OPB_RT,          ALU_ADD,        BRANCH_CMP_GREATER_EQ_Z,     JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          BGTZ    ->  List(BRANCH_Y,    JUMP_N,       DST_X,    WB_N,    OPB_RT,          ALU_ADD,        BRANCH_CMP_GREATER_Z,        JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          BLEZ    ->  List(BRANCH_Y,    JUMP_N,       DST_X,    WB_N,    OPB_RT,          ALU_ADD,        BRANCH_CMP_LESS_EQ_Z,        JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          BLTZ    ->  List(BRANCH_Y,    JUMP_N,       DST_X,    WB_N,    OPB_RT,          ALU_ADD,        BRANCH_CMP_LESS_Z,           JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          BGEZAL  ->  List(BRANCH_Y,    JUMP_N,       DST_L,    WB_Y,    OPB_PCPLUSFOUR,  ALU_ADD,        BRANCH_CMP_GREATER_EQ_Z,     JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
          BLTZAL  ->  List(BRANCH_Y,    JUMP_N,       DST_L,    WB_Y,    OPB_PCPLUSFOUR,  ALU_ADD,        BRANCH_CMP_LESS_Z,           JUMP_X,         MEM_MASK_X,     MEM_SEXT_X,     MEM_WRITE_N,   WB_ALU),
